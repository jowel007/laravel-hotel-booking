    ...
    <div class="container">
        <div class="main-body">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <form id="myForm" action="{{ route('update.book.area') }}" method="post" enctype="multipart/form-data">
                            @csrf
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-9 text-secondary">
                                    <textarea class="form-control" id="input40" name="short_desc" rows="3" placeholder="Short Description">{{ $book->short_desc }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <img id="showimage" src="{{ (!empty($book->image)) ? url('upload/book_image/'.$book->image) : url('upload/no_image.jpg') }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
                                </div>
                            </div>
